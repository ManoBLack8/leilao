...
<div class="wrapper">
    ...
    <!-- Content -->
    <div class="content">
        <div class="title"><h5>Administradores</h5><span id="action-add"><a href="administrador_adicionar.php" title="Adicionar" class="btn14 mr5"><img src="images/icons/dark/add.png" alt="adicionar" title="adicionar" /></a></span></div>
        ...
        <div class="table">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                ...
                <tbody>
                    ...
                    $sql = " SELECT id, login, nome, DATE_FORMAT(criado_em, '%d/%m/%Y %T') AS data_cadastro, status FROM admin  WHERE status > -1 ";
                    $query = $pdo->query($sql);
