...
<div class="wrapper">
    ...
    <!-- Content -->
    <div class="content">
        <div class="title"><h5>Banners</h5><span id="action-add"><a href="banner_adicionar.php" title="Adicionar" class="btn14 mr5"><img src="images/icons/dark/add.png" alt="adicionar" title="adicionar" /></a></span></div>
