...
<div class="loginWrapper">
    ...
    <div class="loginPanel">
        ...
        <form action="logar.php" method="post" id="valid" class="mainForm">
...
<div id="footer">
	<div class="wrapper">
    	<span>Sovinos. &copy; Copyright <?php echo date('Y'); ?>. Todos os direitos reservados.</span>
    </div>
</div>

<script type="text/javascript">
	var erro = "<?php echo $_SESSION['msg_error'] ?>";
	if(erro != ""){
		$.jGrowl(erro, { sticky: true, header: 'ERRO:' });
	}
</script>
